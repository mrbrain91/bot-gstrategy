  ...
  <?php include 'partSite/leftSite.php'; ?>
        ...
        <div>
                <a href="agents.php">
                  ...
                  <i class="fa fa-arrow-circle-o-left" aria-hidden="true"> Назад</i>
                  </button>
                </a>
...
<!-- ulpoad key -->
                    ...
                    <input type="text" class="form-control" placeholder="Например: Андрей" name="name_of_agent" required >
                    </div>

                    <div class="form-group mb-3">
                    <label>
                      Введите номер телефона:<br>
                      в формате (9989х ххх хх хх)
                    </label>
                    <input type="text" class="form-control" placeholder="99899 777 77 77" name="phone_number_of_agent" required >
                    </div>

                    
                    <div class="form-group mb-3">
                        <button type="submit" name="save_agent" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Сохранить</button>
                    </div>
                </form>
