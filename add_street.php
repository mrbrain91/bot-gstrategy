...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="container">
        ...
        <div>
            <a href="street.php?id_region=<?=$id_region?>&&id_quarter=<?=$id_quarter?>&&name_quarter=<?=$name_quarter?>&&name_region=<?=$name_region?>">
        ...
        <div class="card mt-5 ml-5 mr-5 mb-5">
            <div class="card-body">
                <form action="action.php?id_region=<?=$id_region?>&&id_quarter=<?=$id_quarter?>&&name_quarter=<?=$name_quarter?>&&name_region=<?=$name_region?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        <label>Введите название улицы:</label>
                        <input type="text" class="form-control" value="Другой" name="name_of_street">
                    </div>
                    <div class="form-group mb-3">
                        <button type="submit" name="save_street" class="btn btn-primary">
