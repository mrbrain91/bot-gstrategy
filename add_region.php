            ...
            <div class="card-body">
                <form action="action.php" method="POST" enctype="multipart/form-data">
                     <div class="form-group mb-3">
                        ...
                        <select name="region_name" class="form-control" id="exampleFormControlSelect1">
                          <option disabled>выберите:</option>
                          <option value='Алмазар'>Алмазар</option>
                          <option value='Бектемир'>Бектемир</option>
                          <option value="Мирабад">Мирабад</option>
                          <option value="Мирзо_Улугбек">Мирзо_Улугбек</option>
                          ...
                          <option value="Яшнабад">Яшнабад</option>
                          <option value="Янгихаёт">Янгихаёт</option>
                          <option value="Другой">Другой</option>

                        </select>
                    </div>
                    <div class="form-group mb-3">
                        <button type="submit" name="save_region" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> Сохранить</button>
                    </div>
                </form>
            </div>
        </div>
