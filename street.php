...
$count = streetsCount($connect, $id_region, $id_quarter);
...
<html lang="en">
  ...
  <?php include 'partSite/leftSite.php'; ?>
   ...
   <div class="container" style="overflow-x: auto;">
    ...
    <div>
        <a href="https://gstrategy.galaxytest.xyz/add_street.php?id_region=<?=$id_region?>&&id_quarter=<?=$id_quarter?>&&name_quarter=<?=$name_quarter?>&&name_region=<?=$name_region?>">
    ...
    <div>
      ...
      Район: <?php if (isset($name_region) && isset($name_quarter)) {echo $name_region.'<br>Квартал: '.$name_quarter;}?> 
      </span>
    </div>

    <?php
        $query = "SELECT * FROM streets WHERE id_region='$id_region' AND id_quarter= '$id_quarter'";
    ...
    <?php     
            ...
            <!-- <td>
                <a href="street.php?id_quarter=<?=$row["id"]?>&&id_region=<?=$id_region?>" role="button"><button class="btn btn-success">входить</button></a>
            </td>   -->
            </tr>     
            <?php     
                };    
